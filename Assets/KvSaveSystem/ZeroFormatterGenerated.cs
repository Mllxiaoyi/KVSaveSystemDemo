...
namespace ZeroFormatter
{
    ...
    public static partial class ZeroFormatterInitializer
    {
        ...
        public static void Register2()
        {
            ...
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ZeroFormatter.Tests.Sex2>.Register(new ZeroFormatter.DynamicObjectSegments.ZeroFormatter.Tests.Sex2Formatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Comparers.ZeroFormatterEqualityComparer<global::ZeroFormatter.Tests.Sex2>.Register(new ZeroFormatter.DynamicObjectSegments.ZeroFormatter.Tests.Sex2EqualityComparer());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ZeroFormatter.Tests.Sex2?>.Register(new ZeroFormatter.DynamicObjectSegments.ZeroFormatter.Tests.NullableSex2Formatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Comparers.ZeroFormatterEqualityComparer<global::ZeroFormatter.Tests.Sex2?>.Register(new NullableEqualityComparer<global::ZeroFormatter.Tests.Sex2>());
...
namespace ZeroFormatter.DynamicObjectSegments.ZeroFormatter.Tests
{
    ...
    public class Sex2Formatter<TTypeResolver> : Formatter<TTypeResolver, global::ZeroFormatter.Tests.Sex2>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ZeroFormatter.Tests.Sex2 value)
        {
            return BinaryUtil.WriteInt32(ref bytes, offset, (Int32)value);
        }

        public override global::ZeroFormatter.Tests.Sex2 Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = 4;
            return (global::ZeroFormatter.Tests.Sex2)BinaryUtil.ReadInt32(ref bytes, offset);
        }
    }


    public class NullableSex2Formatter<TTypeResolver> : Formatter<TTypeResolver, global::ZeroFormatter.Tests.Sex2?>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override global::ZeroFormatter.Tests.Sex2? Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            ...
            return (global::ZeroFormatter.Tests.Sex2)BinaryUtil.ReadInt32(ref bytes, offset + 1);
        }
    }



    public class Sex2EqualityComparer : IEqualityComparer<global::ZeroFormatter.Tests.Sex2>
    {
        public bool Equals(global::ZeroFormatter.Tests.Sex2 x, global::ZeroFormatter.Tests.Sex2 y)
        {
            return (Int32)x == (Int32)y;
        }

        public int GetHashCode(global::ZeroFormatter.Tests.Sex2 x)
        {
            return (int)x;
        }
    }
